...
- Height: continental fbm (squashed -> coasts/oceans), mountain fbm gated to inland areas, roughness detail, river carving via ridged noise (`|fbm| < 0.035`) down to `SEA_LEVEL - 2`.
...
- Camera spawns above surface at (0, surface+2, 0) once chunk (0,0) arrives.
